...
function RecruiterDashboard() {
	...
	const metricsLoading =
		jobsLoading || interviewsFetching || scoresPending;
			...
			<div className="mx-auto w-full max-w-6xl">
						...
						{jobsLoading || interviewsFetching ? (
							...
							<div className="flex flex-col items-center justify-center px-6 py-16 text-center">
								<div className="mb-4 flex size-14 items-center justify-center rounded-full bg-[#f3f4f6]">
									<Sparkles className="size-7 text-[#9ca3af]" />
								</div>
								<p className="font-medium text-[#111827]">No recent activity</p>
								<p className="mt-1 max-w-sm text-sm text-[#6b7280]">
									Completed interviews will show up here with scores and
									duration once candidates finish sessions.
								</p>
							</div>
						) : (
				...
				<section className="pb-4">
					...
					{jobsLoading || interviewsFetching ? (
						...
						<div className="mt-6 flex flex-col items-center justify-center rounded-xl border border-dashed border-black/15 bg-[#fafafa] px-6 py-14 text-center">
							<div className="mb-4 flex size-14 items-center justify-center rounded-full bg-white">
								<Crown className="size-7 text-[#9ca3af]" />
							</div>
							<p className="font-medium text-[#111827]">
								No scored interviews yet
							</p>
							<p className="mt-1 max-w-sm text-sm text-[#6b7280]">
								When interviews are completed and scored, top performers will
								appear here.
							</p>
						</div>
					) : (
