...
export function DashboardSidebar() {
	...
	return (
		<aside className="flex w-[min(100%,280px)] shrink-0 flex-col border-r border-black/[0.06] bg-[#f9fafb] px-3 py-5 lg:w-[272px]">
			<div className="flex items-center justify-between gap-2 px-1">
				...
				<Button
					...
					variant="outline"
					size="icon"
					className="h-8 w-8 shrink-0 rounded-lg border-black/[0.08] bg-white text-[#6b7280] shadow-none"
